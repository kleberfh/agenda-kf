                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="nome" class="form-control form-control-alternative" placeholder="Fulano da Silva">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="telefone">Telefone <bold>*</bold></label>
                        <input type="text" id="telefone" class="form-control form-control-alternative" placeholder="(12) 3456-7890">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="email" id="email" class="form-control form-control-alternative" placeholder="fulano@email.com">
                        </div>
                    </div>
                  </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea id="notas" rows="4" class="form-control form-control-alternative" placeholder="Fulano é um cara legal..."></textarea>
                            </div>
                        </div>
                    </div>
                </div>
